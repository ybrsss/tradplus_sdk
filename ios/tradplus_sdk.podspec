...
s.dependency 'TradPlusAdSDK', '13.6.0'
s.dependency 'TradPlusAdSDK/FacebookAdapter', '13.6.0'
# s.dependency 'FBAudienceNetwork','6.17.1'
s.dependency 'TradPlusAdSDK/AdMobAdapter', '13.6.0'
s.dependency 'Google-Mobile-Ads-SDK','12.2.0'
s.dependency 'TradPlusAdSDK/UnityAdapter', '13.6.0'
s.dependency 'UnityAds','4.13.2'
s.dependency 'TradPlusAdSDK/AppLovinAdapter', '13.6.0'
s.dependency 'AppLovinSDK','13.2.0'
s.dependency 'TradPlusAdSDK/VungleAdapter', '13.6.0'
s.dependency 'VungleAds', '7.4.5'
s.dependency 'TradPlusAdSDK/InMobiAdapter', '13.6.0'
s.dependency 'InMobiSDK' ,'10.8.2'
s.dependency 'TradPlusAdSDK/MintegralAdapter', '13.6.0'
s.dependency 'MintegralAdSDK' ,'7.7.7'
s.dependency 'MintegralAdSDK/All','7.7.7'
s.dependency 'TradPlusAdSDK/SmaatoAdapter', '13.6.0'
s.dependency 'smaato-ios-sdk', '22.9.3'
s.dependency 'TradPlusAdSDK/TPCrossAdapter', '13.6.0'
s.dependency 'TradPlusAdSDK/BigoAdapter', '13.6.0'
